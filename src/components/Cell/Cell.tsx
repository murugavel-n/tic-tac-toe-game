...
export function Cell({ value, index, isWinning, onClick, disabled }: CellProps) {
  ...
  const baseClasses =
    'w-24 h-24 border-2 rounded-lg text-4xl font-bold flex items-center justify-center transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 outline-none'
