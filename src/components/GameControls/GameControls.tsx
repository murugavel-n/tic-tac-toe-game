  ...
  return (
    <div className="flex flex-col gap-2 w-full">
      <button
        ...
        className="w-full py-2 px-3 sm:px-4 rounded-lg text-xs sm:text-sm font-semibold bg-indigo-800 text-white hover:bg-indigo-900 active:bg-indigo-950 transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 outline-none"
      >
        Next Game
      </button>
      <button
